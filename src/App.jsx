...
export default function App() {
  ...
  const apresentaveis = noticiasFiltradas.map(noticiaApresentavel)
  const destaque = apresentaveis[0]
  const ultimas = apresentaveis.slice(1, 7)
